...
$.fn.GoogleMapPortfolio.app.prototype = {
    ...
    setMap: function() {
        ...
        google.maps.event.addDomListener(window,
            ...
            function() {
                ...
                var i;
                for (i = 0; i < ref.markerss.length; i++) ref.generateMapMarker([ref.markerss[i][0], ref.markerss[i][1]], ref.markerss[i][2], ref.markerss[i][3], ref.markerss[i][4], 1500 * (i + Math.random()) * Math.random(), ref.markerss[i][5]);
    ...
    generateMapMarker: function(b, d, c, e, h, g) { 
        var maps_marker = new google.maps.Marker({
            ...
            map: $.fn.GoogleMapPortfolio.app.map,
            icon: d,
        ...
        google.maps.event.addListener(maps_marker, "click", function() {
            window.location.hash = ref.urlAnchor;
            ref.active = !0;
            ref.openWork();
            $(".work .text").html(c);
            $(".work-image").attr({
